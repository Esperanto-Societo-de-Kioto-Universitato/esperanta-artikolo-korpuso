...
- 輪読候補リスト `rondolegado_kandidatoj_202609.md` を同梱。3 フォルダ(2025-03-03〜2026-09-14、計 1,650 本)から、京大エス研の例会の輪読に向く 50 本を選び、日本語タイトルと短い紹介を付けたもの。各記事の収録フォルダ・ファイルは一覧に記載。
